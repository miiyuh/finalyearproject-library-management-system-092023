                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><?php echo htmlentities($result->register_date); ?></td>
                                                    <td class="center">
                                                        <?php
                                                        if ($result->status == 1) {
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        if ($result->status == 1) {
                                                        ?>
                                                            <a href="reg-students.php?inid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Are you sure you want to deactivate this student account?');">
                                                                <button class="btn btn-danger">Deactivate</button>
                                                            </a>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <a href="reg-students.php?id=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Are you sure you want to reactivate this student account?');">
