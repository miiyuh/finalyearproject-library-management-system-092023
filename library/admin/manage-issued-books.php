                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT students.student_name, books.book_name, books.isbn_number, issued_book_details.issues_date, issued_book_details.return_date, issued_book_details.id as rid FROM issued_book_details JOIN students ON students.student_id = issued_book_details.student_id JOIN books ON books.id = issued_book_details.book_id ORDER BY issued_book_details.id DESC";
