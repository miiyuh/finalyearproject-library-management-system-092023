                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        $sid = $_SESSION['stdid'];
                                        $sql = "SELECT books.book_name, books.isbn_number, issued_book_details.issues_date, issued_book_details.return_date, issued_book_details.id as rid, issued_book_details.fine from issued_book_details join students on students.student_id=issued_book_details.student_id join books on books.id=issued_book_details.book_id where students.student_id=:sid order by issued_book_details.id desc";
                                        $query = $dbh->prepare($sql);
                                        ...
                                        ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><?php echo htmlentities($result->issues_date); ?></td>
                                                    <td class="center">
