...
$sql="update  book_categories set category_name=:category,status=:status where id=:category_id";
...
<input class="form-control" type="text" name="category" value="<?php echo htmlentities($result->category_name);?>" required />
</div>
<div class="form-group">
<label>Status</label>
