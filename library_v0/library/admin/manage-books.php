                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT books.book_name,book_categories.category_name,authors.author_name,books.isbn_number,books.book_price,books.id as book_id,books.book_image from  books join book_categories on book_categories.id=books.category_id join authors on authors.id=books.author_id";
$query = $dbh -> prepare($sql);
$query->execute();
...
<img src="book_img/<?php echo htmlentities($result->book_image);?>" width="100">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->book_price);?></td>
                                            <td class="center">
