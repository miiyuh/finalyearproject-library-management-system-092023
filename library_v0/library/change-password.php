...
if(strlen($_SESSION['login']) == 0) {   
    ...
    if(isset($_POST['change'])) {
        ...
        if (!$recaptcha_json['success']) {
            ...
            $sql = "SELECT student_password FROM students WHERE student_email=:email AND student_password=:password";
            ...
            if($query->rowCount() > 0) {
                $con = "UPDATE students SET student_password=:newpassword WHERE student_email=:email";
