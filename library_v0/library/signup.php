...
if (isset($_POST['signup'])) {
    ...
    $sql = "INSERT INTO students(student_id,student_name,student_phonenumber,student_email,student_password,status) VALUES(:student_id,:fname,:mobileno,:email,:student_password,:status)";
    ...
    if ($lastInsertId) {
        echo '<script>alert("Registered account successfully. Your assigned Student ID is ' . $student_id . '")</script>';
    } else {
    ...
    <script>
        function checkAvailability() {
            ...
            jQuery.ajax({
                ...
                data: 'student_email=' + $("#student_email").val(),
                type: "POST",
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form name="signup" method="post" onSubmit="return valid();">
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="form-control" type="email" name="email" id="student_email" onBlur="checkAvailability()" autocomplete="off" required />
